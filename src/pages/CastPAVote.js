...
class CastPAVote extends Component {
    ...
    render() {
        return (
            <Router>
                ...
                <Switch>
                    <Route exact path="/CastPAVote" exact render={() => {
                        return (
                            <div>
                                ...
                                <div className="App__Background">
                                    ...
                                    <div className="Subtitle">
                                        <label className="Subtitle">Cast Provincial Assembly Vote</label>
                                    </div>
